...
const FeatureBoxes = () => {
  ...
  return (
    <Section id="features" className="pt-0 pb-20 md:pt-0 md:pb-32 -mt-20 relative z-10">
      <Container>
        <motion.div 
      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {featuredProjects.map((project, index) => {
            // Format gradient class for ProjectCard
            const gradientClass = tileColors[index % tileColors.length]
              .split(' ')[0] // Take the first gradient class
              .replace('bg-gradient-to-', '') // Remove bg-gradient-to-
              .replace('from-', 'from-') // Ensure from- prefix
              .replace('to-', 'to-'); // Ensure to- prefix
